        ...
        <Card>
          ...
          <CardContent>
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell className="font-mono">QWE234SDF</TableCell>
                  <TableCell>John Kamau</TableCell>
                  <TableCell>KCSE Math</TableCell>
                  <TableCell>KES 500</TableCell>
                  <TableCell className="text-green-600 font-medium">Completed</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-mono">ASD456GHJ</TableCell>
                  <TableCell>Mary Wanjiku</TableCell>
                  <TableCell>Biology Form 4</TableCell>
                  <TableCell>KES 300</TableCell>
